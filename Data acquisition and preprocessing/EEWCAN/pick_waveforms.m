...
xlswrite('\EEWCAN\xinxi.xlsx',dat_info);

save('\EEWCAN\ACC_UD.mat','ACC_UD'); 
save('\EEWCAN\ACC_EW.mat','ACC_EW');
save('\EEWCAN\ACC_NS.mat','ACC_NS');

save('\EEWCAN\VEL_UD.mat','VEL_UD');
save('\EEWCAN\VEL_EW.mat','VEL_EW');
save('\EEWCAN\VEL_NS.mat','VEL_NS');

save('\EEWCAN\DIS_UD.mat','DIS_UD'); 
save('\EEWCAN\DIS_EW.mat','DIS_EW');
save('\EEWCAN\DIS_NS.mat','DIS_NS');
