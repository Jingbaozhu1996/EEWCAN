...
xlswrite('\CNN-Dis\xinxi.xlsx',dat_info);

save('\CNN-Dis\ACC_UD.mat','ACC_UD'); 
save('\CNN-Dis\ACC_EW.mat','ACC_EW');
save('\CNN-Dis\ACC_NS.mat','ACC_NS');

save('\CNN-Dis\VEL_UD.mat','VEL_UD');
save('\CNN-Dis\VEL_EW.mat','VEL_EW');
save('\CNN-Dis\VEL_NS.mat','VEL_NS');

save('\CNN-Dis\DIS_UD.mat','DIS_UD'); 
save('\CNN-Dis\DIS_EW.mat','DIS_EW');
save('\CNN-Dis\DIS_NS.mat','DIS_NS');
