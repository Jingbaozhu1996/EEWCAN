...
xlswrite('\MagNet\xinxi.xlsx',dat_info);

save('\MagNet\ACC_UD.mat','ACC_UD'); 
save('\MagNet\ACC_EW.mat','ACC_EW');
save('\MagNet\ACC_NS.mat','ACC_NS');

save('\MagNet\VEL_UD.mat','VEL_UD');
save('\MagNet\VEL_EW.mat','VEL_EW');
save('\MagNet\VEL_NS.mat','VEL_NS');

save('\MagNet\DIS_UD.mat','DIS_UD'); 
save('\MagNet\DIS_EW.mat','DIS_EW');
save('\MagNet\DIS_NS.mat','DIS_NS');
