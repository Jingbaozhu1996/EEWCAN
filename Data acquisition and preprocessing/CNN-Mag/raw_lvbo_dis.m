...
%巴特沃斯滤波
function [d_ud,d_ew,d_ns]= raw_lvbo_dis(inputA,inputB,inputC,output2,dt,T)
...
t2=0:dt:t4;
d_ud=dA(nn1+1:nn1+t4/dt);%时间窗内的位移
d_ew=dB(nn2+1:nn2+t4/dt);%时间窗内的位移
d_ns=dC(nn3+1:nn3+t4/dt);%时间窗内的位移
