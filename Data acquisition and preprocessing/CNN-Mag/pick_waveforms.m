...
xlswrite('\CNN-Mag\xinxi.xlsx',dat_info);

save('\CNN-Mag\ACC_UD.mat','ACC_UD'); 
save('\CNN-Mag\ACC_EW.mat','ACC_EW');
save('\CNN-Mag\ACC_NS.mat','ACC_NS');

save('\CNN-Mag\VEL_UD.mat','VEL_UD');
save('\CNN-Mag\VEL_EW.mat','VEL_EW');
save('\CNN-Mag\VEL_NS.mat','VEL_NS');

save('\CNN-Mag\DIS_UD.mat','DIS_UD'); 
save('\CNN-Mag\DIS_EW.mat','DIS_EW');
save('\CNN-Mag\DIS_NS.mat','DIS_NS');
