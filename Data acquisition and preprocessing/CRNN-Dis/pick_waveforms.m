...
xlswrite('\CRNN-Dis\xinxi.xlsx',dat_info);

save('\CRNN-Dis\ACC_UD.mat','ACC_UD'); 
save('\CRNN-Dis\ACC_EW.mat','ACC_EW');
save('\CRNN-Dis\ACC_NS.mat','ACC_NS');

save('\CRNN-Dis\VEL_UD.mat','VEL_UD');
save('\CRNN-Dis\VEL_EW.mat','VEL_EW');
save('\CRNN-Dis\VEL_NS.mat','VEL_NS');

save('\CRNN-Dis\DIS_UD.mat','DIS_UD'); 
save('\CRNN-Dis\DIS_EW.mat','DIS_EW');
save('\CRNN-Dis\DIS_NS.mat','DIS_NS');
