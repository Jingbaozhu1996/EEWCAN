...
xlswrite('\EqViT\xinxi.xlsx',dat_info);

save('\EqViT\ACC_UD.mat','ACC_UD'); 
save('\EqViT\ACC_EW.mat','ACC_EW');
save('\EqViT\ACC_NS.mat','ACC_NS');

save('\EqViT\VEL_UD.mat','VEL_UD');
save('\EqViT\VEL_EW.mat','VEL_EW');
save('\EqViT\VEL_NS.mat','VEL_NS');

save('\EqViT\DIS_UD.mat','DIS_UD'); 
save('\EqViT\DIS_EW.mat','DIS_EW');
save('\EqViT\DIS_NS.mat','DIS_NS');
